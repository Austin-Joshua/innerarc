...
const SCREENS = [
  { id: "capture", path: "/food-capture", wait: /log a meal/i },
  { id: "result", path: "/food-result", wait: /margherita pizza|confidence/i },
  { id: "edit", path: "/food-edit", wait: /correct the dish/i },
  { id: "nutrition", path: "/food-nutrition", wait: /margherita pizza|meal calories/i },
];
      ...
      for (const theme of ["light", "dark"]) {
        for (const screen of SCREENS) {
          ...
          const file = path.join(
            OUT_DIR,
            `module-17-phase2-batch-b-${screen.id}-${viewport.name}-${theme}.png`,
          );
