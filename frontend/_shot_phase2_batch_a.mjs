...
const SCREENS = [
  { id: "home", path: "/home", wait: /today/i },
  { id: "login", path: "/login", wait: /welcome back/i },
  { id: "signup", path: "/signup", wait: /create your account/i },
  { id: "onboarding", path: "/onboarding", wait: /your starting point/i },
];
      ...
      for (const theme of ["light", "dark"]) {
        for (const screen of SCREENS) {
          ...
          const file = path.join(
            OUT_DIR,
            `module-17-phase2-batch-a-${screen.id}-${viewport.name}-${theme}.png`,
          );
